...
<section><h2 id="synchronize-between-devices">Synchronize between devices.</h2><p>The <a href="https://beta.tinybase.org/api/mergeable-store/interfaces/mergeable/mergeablestore/"><code>MergeableStore</code></a> type acts as a native CRDT, letting you merge data and synchronize it between clients and systems. The synchronization protocol can run over WebSockets, the browser BroadcastChannel, or your own custom synchronization medium.</p><p>Read more about these techniques in the <a href="https://beta.tinybase.org/guides/synchronization/">Synchronization</a> guides.</p></section>
