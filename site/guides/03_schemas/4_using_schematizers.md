...
from libraries like Zod, and convert them at runtime using a schematizer.
...
Currently, TinyBase provides a Zod schematizer, with support for additional
libraries coming in future releases.
