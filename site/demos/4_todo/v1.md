...
## The Top-Level `Demo` Component

We have a top-level `Demo` component, in which we create our Store object with
...
When the window loads, we render the `Demo` component to start the app:
