...
![EditableValueView](/shots/editablevalueview-solid-demo.png)
...
changes to the <ValuesInHtmlTable /> (Solid) demo to show this new component.

[base]: # '<ValuesInHtmlTable /> (Solid)'
...
+import {EditableValueView, ValuesInHtmlTable} from 'tinybase/ui-solid-dom';
```
...
equivalent <EditableCellView /> (Solid) demo.
