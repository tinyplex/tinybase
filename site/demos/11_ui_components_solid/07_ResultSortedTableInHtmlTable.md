...
![ResultSortedTableInHtmlTable](/shots/resultsortedtableinhtmltable-solid-demo.png)
...
changes to the <SortedTableInHtmlTable /> (Solid) demo to support this new
component.
...
[base]: # '<SortedTableInHtmlTable /> (Solid)'
...
+import {Provider, useCell, useCreateQueries, useCreateStore} from 'tinybase/ui-solid';
