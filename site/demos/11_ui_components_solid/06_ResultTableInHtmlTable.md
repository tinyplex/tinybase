...
![ResultTableInHtmlTable](/shots/resulttableinhtmltable-solid-demo.png)
...
back and making changes to the <TableInHtmlTable /> (Solid) demo to
...
let's look at the next <ResultSortedTableInHtmlTable /> (Solid) demo.
