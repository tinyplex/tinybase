...
![TableInHtmlTable](/shots/tableinhtmltable-solid-demo.png)
...
changes to the <ValuesInHtmlTable /> (Solid) demo to support this new
component.
...
<SortedTableInHtmlTable /> (Solid) demo.
