...
![SliceInHtmlTable](/shots/sliceinhtmltable-solid-demo.png)
...
back and making changes to the <TableInHtmlTable /> (Solid) demo to demonstrate
...
+import {Provider, useCell, useCreateIndexes, useCreateStore} from 'tinybase/ui-solid';
...
<RelationshipInHtmlTable /> (Solid) demo.
