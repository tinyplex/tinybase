...
![ValuesInHtmlTable](/shots/valuesinhtmltable-solid-demo.png)
...
First, we create the import aliases for TinyBase and Solid modules we'll need:
...
We need the following parts of the TinyBase API, the ui-solid module, and Solid
itself:
...
This is the main container of the demo, in a Solid component called `App`. It
...
with some data, we can render it with components from the ui-solid-dom module.
...
There is plenty more that you can do with the ui-solid-dom module's components,
and so please continue to the next <TableInHtmlTable /> (Solid) demo.
