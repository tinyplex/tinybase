...
![EditableCellView](/shots/editablecellview-solid-demo.png)
...
changes to the <TableInHtmlTable /> (Solid) demo to show this new component.
...
+import {EditableCellView, TableInHtmlTable} from 'tinybase/ui-solid-dom';
```
...
proceed to the <Inspector /> (Solid) demo.
