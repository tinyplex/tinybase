...
![SortedTableInHtmlTable](/shots/sortedtableinhtmltable-solid-demo.png)
...
changes to the <TableInHtmlTable /> (Solid) demo to support this new component.
