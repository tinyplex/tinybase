  ...
  return (
    <HtmlTable
      ...
      params={useMemo(
        ...
        [tableId, store, editable, defaultCellIds],
      )}
    ...
    <HtmlTable
      ...
      params={
        useMemo(
          ...
          [remoteTableId, store, editable, defaultCellIds],
        ) as HtmlTableParams
      }
...
export const ResultTableInHtmlTable: typeof ResultTableInHtmlTableDecl = ({
  ...
  return (
    <HtmlTable
      {...props}
      params={useMemo(
        () => [{queryId, queries}, ResultCellView, defaultCellIds],
        [queryId, queries, defaultCellIds],
      )}
