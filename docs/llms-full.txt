...
- **Databases**: SQLite (Node, Bun, WASM), PostgreSQL, PGlite, SQL Server,
  Turso (libSQL)
- **Third-party**: PowerSync
...
4. **Generated Files**: `/releases.md` and `/readme.md` in the root are
   **GENERATED** from `/site/guides/20_releases.md` and `/site/home/index.md`.
...
3. **Release Notes**: Edit `/site/guides/20_releases.md` (not `/releases.md`)
