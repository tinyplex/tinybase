...
import React2 from "https://esm.sh/react@^19.2.8";
import { Fragment as Fragment$1, jsx as jsx2, jsxs } from "https://esm.sh/react@^19.2.8/jsx-runtime";
...
var useCreateAsync = (store, create, createDeps, then, thenDeps, destroy, destroyDeps) => {
  ...
  const destroyingRef = useRef(void 0);
  useEffect(
    () => {
  ...
  useEffect(
    () => {
      let current = true;
      let createdThing;
      const destroyThing = (thing2) => tryFinallyAsync(
        () => thing2.destroy(),
        () => destroyRef.current?.(thing2)
      );
      void tryCatch(async () => {
        ...
        const nextThing = store ? await create(store) : void 0;
        if (!current) {
          if (nextThing) {
        ...
        createdThing = nextThing;
        setThing([creation, nextThing]);
        if (nextThing && then) {
      ...
      return () => {
        current = false;
        if (createdThing) {
          destroyingRef.current = tryCatch(() => destroyThing(createdThing));
        }
      };
    },
    // eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  return thing?.[0] === creation ? thing[1] : void 0;
};
...
var useCreatePersister = (store, create, createDeps = EMPTY_ARRAY, then, thenDeps = EMPTY_ARRAY, destroy, destroyDeps = EMPTY_ARRAY) => useCreateAsync(
  store,
  create,
  createDeps,
  then,
...
var isEmpty = (thing) => size2(thing) == 0;
...
var createCustomPersister = (store, getPersisted, setPersisted, addPersisterListener, delPersisterListener, onIgnoredError, persist, extra = {}, isSynchronizer = 0, scheduleId = []) => {
  ...
  const destroy = async () => {
    if (isUndefined2(destroying)) {
      ...
      destroying = (async () => {
        const scheduledActions = mapGet(scheduleActions, scheduleId);
        const remainingActions = arrayFilter2(
          scheduledActions,
          ([, complete, owner]) => {
...
var useSortedRowIds = (tableIdOrArgs, cellIdOrStoreOrStoreId, descending, offset, limit, sorterOrStoreOrStoreId, storeOrStoreId) => useSortedRowIdsImpl(
  ...isObject2(tableIdOrArgs) ? [
    ...
    offset,
    limit,
    isFunction2(sorterOrStoreOrStoreId) ? sorterOrStoreOrStoreId : void 0,
    isFunction2(sorterOrStoreOrStoreId) ? storeOrStoreId : sorterOrStoreOrStoreId
  ]
);
...
var IndexesView = ({ indexesId, s }) => {
  ...
  return isUndefined2(indexes) ? null : /* @__PURE__ */ jsx2(Details, {
    ...
    s,
    children: isEmpty(indexIds) ? "No indexes defined" : sortedIdsMap(
      indexIds,
...
var MetricsView = ({ metricsId, s }) => {
  ...
  return isUndefined2(metrics) ? null : /* @__PURE__ */ jsx2(Details, {
    ...
    s,
    children: isEmpty(metricIds) ? "No metrics defined" : /* @__PURE__ */ jsxs("table", {
      children: [
        /* @__PURE__ */ jsxs("thead", {
          children: [
...
var QueriesView = ({ queriesId, s }) => {
  ...
  return isUndefined2(queries) ? null : /* @__PURE__ */ jsx2(Details, {
    ...
    s,
    children: isEmpty(queryIds) ? "No queries defined" : sortedIdsMap(
      queryIds,
...
var RelationshipsView = ({ relationshipsId, s }) => {
  ...
  return isUndefined2(relationships) ? null : /* @__PURE__ */ jsx2(Details, {
    ...
    s,
    children: isEmpty(relationshipIds) ? "No relationships defined" : sortedIdsMap(
      relationshipIds,
...
var TablesView = ({ store, storeId, s }) => {
  ...
  return /* @__PURE__ */ jsxs(Details, {
    ...
    s,
    children: [
      isEmpty(tableIds) ? /* @__PURE__ */ jsx2("p", { children: "No tables." }) : sortedIdsMap(
        tableIds,
...
var ValuesView = ({ store, storeId, s }) => {
  ...
  return /* @__PURE__ */ jsxs(Details, {
    ...
    s,
    children: [
      isEmpty(useValueIds(store)) ? /* @__PURE__ */ jsx2("p", { children: "No values." }) : /* @__PURE__ */ jsx2(ValuesInHtmlTable, {
        store,
        editable,
...
var Body = ({ s }) => {
  ...
  return isUndefined2(store) && isEmpty(storeIds) && isUndefined2(metrics) && isEmpty(metricsIds) && isUndefined2(indexes) && isEmpty(indexesIds) && isUndefined2(relationships) && isEmpty(relationshipsIds) && isUndefined2(queries) && isEmpty(queriesIds) ? /* @__PURE__ */ jsx2("span", {
    className: "warn",
