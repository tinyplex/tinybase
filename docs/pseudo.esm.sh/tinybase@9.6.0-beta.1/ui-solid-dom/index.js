...
var objHas2 = (obj, id) => object2.hasOwn(obj, id);
var objGet2 = (obj, id) => ifNotUndefined2(
  obj,
  (obj2) => ifNotUndefined2(object2.getOwnPropertyDescriptor(obj2, id), () => obj2[id])
);
var objSet = (obj, id, value) => {
  object2.defineProperty(obj, id, {
    configurable: true,
    enumerable: true,
    value,
    writable: true
...
var objForEach = (obj, cb) => arrayForEach(objIds2(obj), (id) => cb(obj[id], id));
var objEvery2 = (obj, cb) => {
  for (const id in obj) {
    if (objHas2(obj, id) && !cb(obj[id], id)) {
      return false;
    }
  }
  return true;
};
var objToArray = (obj, cb) => arrayMap2(objEntries(obj), ([id, value]) => cb(value, id));
var objMap = (obj, cb) => {
  const mapped = objNew();
...
var argsOrGetArgs = (args, store, parameter) => arrayMap2(
  args,
  (arg) => isFunction2(arg) ? isEmpty(arg) ? getThing2(arg) : arg(parameter, store) : arg
);
...
var ResultTableInHtmlTable = (props) => createComponent2(
  HtmlTable,
  mergeProps$1(props, {
    get params() {
      return getParams(
...
var TableInHtmlTable = (props) => createComponent2(
  HtmlTable,
  mergeProps$1(props, {
    get params() {
      return getParams(
