...
var Provider = ({
  ...
  const extraThingRegistrations = useRef(arrayNew(8, () => mapNew())).current;
  const setExtraThingById = useCallback(
    (thingOffset, id, thing) => setExtraThingsById(
      (extraThingsById2) => objGet(extraThingsById2[thingOffset], id) == thing ? extraThingsById2 : arrayWith(
        extraThingsById2,
        thingOffset,
        isUndefined(thing) ? objDel({ ...extraThingsById2[thingOffset] }, id) : {
...
var useSortedRowIdsListenerImpl = (tableId, cellId, descending, offset, limit, sorter, listener, listenerDeps, mutator, storeOrStoreId) => {
  const sortedRowIdsArgs = useMemo(
    () => ({ tableId, cellId, descending, offset, limit, sorter }),
    [tableId, cellId, descending, offset, limit, sorter]
  );
...
var useCreateSynchronizer = (store, create, createDeps = EMPTY_ARRAY, destroy, destroyDeps = EMPTY_ARRAY) => useCreateAsync(
  store,
  create,
  createDeps,
  void 0,
...
var Wrap = ({ children, separator, debugIds, id }) => {
...
var MetricView = ({ metricId, metrics, debugIds }) => /* @__PURE__ */ jsx(Wrap, {
  debugIds,
  id: metricId,
...
var RemoteRowView = ({
  ...
  return /* @__PURE__ */ jsx(Wrap, {
    debugIds,
    id: localRowId,
    children: isUndefined(remoteTableId) || isUndefined(rowId) ? null : /* @__PURE__ */ jsx(
      Row,
      {
        ...getProps(getRowComponentProps, rowId),
