...
<h2 id="a-relational-database-in-the-browser-with-tinyjoin">A Relational Database In The Browser, With TinyJoin</h2><p>The new <a href="https://beta.tinybase.org/api/persister-tinyjoin/"><code>persister-tinyjoin</code></a> module provides the <a href="https://beta.tinybase.org/api/persister-tinyjoin/interfaces/persister/tinyjoinpersister/"><code>TinyJoinPersister</code></a>, which saves and loads a <a href="https://beta.tinybase.org/api/the-essentials/creating-stores/store/"><code>Store</code></a> to and from a <a href="https://tinyjoin.org">TinyJoin</a> database - a tiny, worker-first relational database that runs entirely in the browser:</p>
