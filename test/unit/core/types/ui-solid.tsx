...
const UiSolidWithSchemas = UiSolid as UiSolid.WithSchemas<
...
const UiSolidWithSchemas2 = UiSolid as UiSolid.WithSchemas<
  [{t2: {c2: {type: 'number'}}}, NoValuesSchema]
>;
const {useStore: useStore2} = UiSolidWithSchemas2;
