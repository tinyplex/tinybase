...
export const DOC_SHOTS: readonly DocShot[] = [
  ...
  {
    asset: 'basic-chart-react-demo.png',
    framed: false,
    marginRem: 0,
    page: '/demos/chart-components-react/linechart/',
    readySelector: 'svg.chart .plot .line',
    selector: 'iframe',
    style: IFRAME_DOC_SHOT_STYLE,
  },
  {
    asset: 'styled-chart-react-demo.png',
    framed: false,
    marginRem: 0,
    page: '/demos/chart-components-react/linechart-styled/',
    readySelector: 'svg.chart .plot .line',
    selector: 'iframe',
    style: IFRAME_DOC_SHOT_STYLE,
  },
  {
    asset: 'composing-charts-react-demo.png',
    framed: false,
    marginRem: 0,
    page: '/demos/chart-components-react/composing-charts/',
    readySelector: 'svg.chart-mixed .plot .line',
    selector: 'iframe',
    style: IFRAME_DOC_SHOT_STYLE,
  },
  {
    asset: 'sorting-and-types-react-demo.png',
    framed: false,
    marginRem: 0,
    page: '/demos/chart-components-react/sorting-and-types/',
    readySelector: 'svg.chart-booleans .plot .bar',
    selector: 'iframe',
    style: IFRAME_DOC_SHOT_STYLE,
  },
  {
